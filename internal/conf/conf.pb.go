...
type Data struct {
	...
	StandardScoreFormulaConfig *Data_StandardScoreFormulaConfig `protobuf:"bytes,4,opt,name=standard_score_formula_config,json=standardScoreFormulaConfig,proto3" json:"standard_score_formula_config"`
}
...
func (x *Data) GetStandardScoreFormulaConfig() *Data_StandardScoreFormulaConfig {
	if x != nil {
		return x.StandardScoreFormulaConfig
	}
	return nil
}
...
type Data_Redis struct {
	...
	Host         string               `protobuf:"bytes,1,opt,name=host,json=host,proto3" json:"host"`
	Port         int32                `protobuf:"varint,2,opt,name=port,json=port,proto3" json:"port"`
	Password     string               `protobuf:"bytes,3,opt,name=password,json=password,proto3" json:"password"`
	Database     int32                `protobuf:"varint,4,opt,name=database,json=database,proto3" json:"database"`
	PoolSize     int32                `protobuf:"varint,5,opt,name=pool_size,json=poolSize,proto3" json:"pool_size"`
	MinIdleConns int32                `protobuf:"varint,6,opt,name=min_idle_conns,json=minIdleConns,proto3" json:"min_idle_conns"`
	DialTimeout  *durationpb.Duration `protobuf:"bytes,7,opt,name=dial_timeout,json=dialTimeout,proto3" json:"dial_timeout"`
	ReadTimeout  *durationpb.Duration `protobuf:"bytes,8,opt,name=read_timeout,json=readTimeout,proto3" json:"read_timeout"`
	WriteTimeout *durationpb.Duration `protobuf:"bytes,9,opt,name=write_timeout,json=writeTimeout,proto3" json:"write_timeout"`
}
...
type Data_JWT struct {
	...
	ExamSecret               string `protobuf:"bytes,2,opt,name=exam_secret,json=examSecret,proto3" json:"exam_secret"`
	AccessTokenExpireMinutes int64  `protobuf:"varint,3,opt,name=access_token_expire_minutes,json=accessTokenExpireMinutes,proto3" json:"access_token_expire_minutes"`
}
...
func (x *Data_JWT) GetExamSecret() string {
	if x != nil {
		return x.ExamSecret
	}
	return ""
...
type Data_StandardScoreFormulaConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Expression string `protobuf:"bytes,1,opt,name=expression,json=expression,proto3" json:"expression"`
	Rounding   int64  `protobuf:"varint,2,opt,name=rounding,json=rounding,proto3" json:"rounding"`
}

func (x *Data_StandardScoreFormulaConfig) Reset() {
	*x = Data_StandardScoreFormulaConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *Data_StandardScoreFormulaConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_StandardScoreFormulaConfig) ProtoMessage() {}

func (x *Data_StandardScoreFormulaConfig) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_StandardScoreFormulaConfig.ProtoReflect.Descriptor instead.
func (*Data_StandardScoreFormulaConfig) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 3}
}

func (x *Data_StandardScoreFormulaConfig) GetExpression() string {
	if x != nil {
		return x.Expression
	}
	return ""
...
func (x *Data_StandardScoreFormulaConfig) GetRounding() int64 {
	if x != nil {
		return x.Rounding
	}
	return 0
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x8f, 0x07, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61,
	...
	,
	...
	0x09, 0x52, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x1a, 0xe6, 0x02, 0x0a, 0x05, 0x52, 0x65,
	...
	0x61, 0x73, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x6f, 0x6f, 0x6c, 0x5f, 0x73, 0x69, 0x7a, 0x65,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x70, 0x6f, 0x6f, 0x6c, 0x53, 0x69, 0x7a, 0x65,
	0x12, 0x24, 0x0a, 0x0e, 0x6d, 0x69, 0x6e, 0x5f, 0x69, 0x64, 0x6c, 0x65, 0x5f, 0x63, 0x6f, 0x6e,
	0x6e, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x6d, 0x69, 0x6e, 0x49, 0x64, 0x6c,
	...
	,
	...
	0x08, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x08, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x42, 0x1d, 0x5a, 0x1b, 0x65, 0x78, 0x61,
	0x6d, 0x5f, 0x61, 0x70, 0x69, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_StandardScoreFormulaConfig)(nil), // 8: kratos.api.Data.StandardScoreFormulaConfig
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 7: kratos.api.Data.standard_score_formula_config:type_name -> kratos.api.Data.StandardScoreFormulaConfig
...
func file_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_conf_conf_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Data_StandardScoreFormulaConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
